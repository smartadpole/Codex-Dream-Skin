...
assert.ok(
  !css.includes(".dream-skin-panel-focus") &&
    !template.includes("pointerover") &&
    !template.includes("pointerout") &&
    !template.includes("panelFocusHandler"),
  "Block focus must not use pointerover layout reads or a moving panel overlay.",
);
assert.match(
  template,
